...
- Image quality and asset fidelity: place and inbox cards use category icons; user photos are intentionally unsupported to keep the personal workflow lightweight.
...
**Patches Made**
- Replaced recommendation thumbnails with category-led cards.
